...
`mask-rcnn-training-proc-data`, the following command can
be used:

=== "Local Machine / Polyaxon VSCode Terminal"

    ```bash
    $ gsutil mb -p cvhub-312105 -c STANDARD -l ASIA-SOUTHEAST1 -b on gs://mask-rcnn-training-proc-data
    Creating gs://mask-rcnn-training-proc-data/...
    ```
